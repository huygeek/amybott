    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl p-0 gap-0">
        <DialogHeader className="px-5 py-4 border-b">
          <DialogTitle className="text-base font-medium">Add Text Content</DialogTitle>
...
function getTypeBadge(type: KnowledgeItem["type"]) {
  switch (type) {
    case "text":
      return { label: "Text", color: "bg-blue-100 text-blue-800 border-blue-200" }
    case "file":
      return { label: "File", color: "bg-purple-100 text-purple-800 border-purple-200" }
    case "drive":
      return { label: "Drive", color: "bg-green-100 text-green-800 border-green-200" }
    default:
      return { label: "Text", color: "bg-blue-100 text-blue-800 border-blue-200" }
  }
}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {/* Add Text Content */}
                    <Card className="hover:shadow-md transition-all cursor-pointer" onClick={() => setShowAddTextModal(true)}>
                      <CardContent className="p-3">
                        <div className="flex flex-col items-center text-center gap-2">
                          <div className="flex items-center justify-center w-8 h-8 bg-blue-100 rounded-lg">
                            <FileText className="h-4 w-4 text-blue-700" />
                          </div>
                          <h4 className="text-sm font-medium">Add text content</h4>
                        </div>
                      </CardContent>
                    </Card>

                    {/* Upload File */}
                    <Card className="hover:shadow-md transition-all cursor-pointer" onClick={handleFileUpload}>
                      <CardContent className="p-3">
                        <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <Card className="hover:shadow-md transition-all cursor-pointer" onClick={handleGoogleDriveUpload}>
                      <CardContent className="p-3">
                        <div className="flex flex-col items-center text-center gap-2">
                          <div className="flex items-center justify-center w-8 h-8 bg-green-100 rounded-lg">
                            <ExternalLink className="h-4 w-4 text-green-700" />
                          </div>
                          <h4 className="text-sm font-medium">Upload from Google Drive</h4>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-medium">Knowledge History</h3>
