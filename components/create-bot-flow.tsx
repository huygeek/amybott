...
const aiModels = [
  ...
  { id: "claude-4-sonnet", name: "Claude 4 Sonnet", badge: "Official", icon: SparklesIcon },
...
export function CreateBotFlow({ isOpen, onClose, onSuccess }: CreateBotFlowProps) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-60" onClick={handleCancel} />
      
      <div className="fixed inset-0 z-70 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl h-[90vh] bg-background rounded-2xl shadow-xl flex overflow-hidden">
          {/* Sidebar Navigation */}
          <div className="w-80 bg-muted border-r p-6">
            ...
            <div className="space-y-2">
              <div className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
                currentStep === 1 ? "bg-accent border-l-4 border-primary" : "text-muted-foreground"
              }`}>
                <span className="font-medium">1. General info*</span>
              </div>
              
              <div className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
                currentStep === 2 ? "bg-accent border-l-4 border-primary" : "text-muted-foreground"
              }`}>
    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div className="space-y-3">
        ...
        <Input
          ...
          className="h-12 bg-muted border-border focus:bg-background"
        />
      ...
      <div className="space-y-3">
        ...
        <Textarea
          ...
          className="min-h-[120px] bg-muted border-border focus:bg-background resize-none"
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Select value={formData.model} onValueChange={(value) => updateFormData("model", value)}>
          <SelectTrigger className="h-12 bg-muted border-border focus:bg-background hover:bg-background">
            <SelectValue>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            size="sm"
            onClick={addWebsite}
            className="h-10 w-full border-dashed hover:bg-muted"
          >
